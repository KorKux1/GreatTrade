...
namespace GreatTrade.Controllers
{
    public class TagsController : Controller
    {
        ...
        public TagsController(GreatTradeContext context)
        {
            _context = context;
        }
        ...
        {
            var greatTradeContext = _context.Tags.Include(t => t.Alert).Include(t => t.Product);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Description,ProductId,AlertId,Id")] Tag tag)
        {
            if (id != tag.Id)
            {
                return NotFound();
