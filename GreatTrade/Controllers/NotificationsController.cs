...
namespace GreatTrade.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public NotificationsController(GreatTradeContext context)
        {
            _context = context;
        }
        ...
        {
            var greatTradeContext = _context.Notifications.Include(n => n.User);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UserId,Type,Checked,Messasge,Id")] Notification notification)
        {
